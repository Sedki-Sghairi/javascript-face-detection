!(function(t, e) {
							...
							if (
								...
								i &&
									(a =
										2 & e[0]
											? i.return
											: e[0] ? i.throw || ((a = i.return) && a.call(i), 0) : i.next) &&
									!(a = a.call(i, e[1])).done)
							)
								return a;
		...
		return Array.isArray(t)
			...
			: t instanceof Float32Array
				...
				: t instanceof Int32Array || t instanceof Uint8Array
					? 'int32'
					: H(t) ? 'float32' : V(t) ? 'string' : e(t) ? 'bool' : 'float32';
	}
	function j(t) {
	...
	function st(t, e, n) {
		return C(
			Array.isArray(t)
				...
				: V(t) ? "'" + t + "'" : 'bool' === n ? ut(t) : parseFloat(t.toFixed(it)).toString(),
			e
		);
	}
	function ut(t) {
	...
	var dt = (function() {
		...
		return (
			...
			(o.prototype.matMul = function(t, e, n) {
				return (
					void 0 === e && (e = !1), void 0 === n && (n = !1), this.throwIfDisposed(), pt.matMul(this, t, e, n)
				);
			}),
			...
			(o.prototype.prod = function(t, e) {
				return (
					void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), pt.prod(this, t, e)
				);
			}),
			(o.prototype.mean = function(t, e) {
				return (
					void 0 === t && (t = null), void 0 === e && (e = !1), this.throwIfDisposed(), pt.mean(this, t, e)
				);
			}),
		...
		Ft = (function() {
			...
			return (
				...
				(t.prototype.endScope = function(t) {
					...
					(this.activeScope =
						0 === this.scopeStack.length ? null : this.scopeStack[this.scopeStack.length - 1]),
				...
				(t.prototype.gradients = function(t, o, i, e) {
					...
					return this.tidy('backward', function() {
						var t,
							...
							n = {};
						(n[s.id] =
							null == i ? ((t = s.shape), (e = Q(B(t), 'float32')), dt.make(t, { values: e })) : i),
							(function(a, s, u) {
								for (
									var t = function(t) {
											var o = s[t],
				...
				(t.prototype.track = function(t) {
					...
					return (
						null != this.activeScope && ((t.scopeId = this.activeScope.id), this.activeScope.track.push(t)),
						t
					);
				}),
				(t.nextTensorId = 0),
			...
			return (
				...
				(t.prototype.evaluateFeature = function(t) {
					...
					if ('WEBGL_NUM_MB_BEFORE_PAGING' === t)
						return this.get('PROD') || !this.get('IS_BROWSER')
							...
							: window.screen.height * window.screen.width * window.devicePixelRatio * 600 / 1024;
						...
						return 0 === e
							...
							: (function(t) {
									...
									return Vt(e, 'EXT_disjoint_timer_query_webgl2') && 2 === t
										? 2
										: Vt(e, 'EXT_disjoint_timer_query') ? 1 : 0;
								})(e);
					}
					...
					if ('WEBGL_FENCE_API_ENABLED' === t)
						return 2 === (r = this.get('WEBGL_VERSION')) && null != l(r).fenceSync;
				...
				(t.prototype.registerBackend = function(t, e, n) {
					...
					if ((void 0 === n && (n = 1), t in this.registry))
						return console.warn(t + ' backend was already registered. Reusing existing backend'), !1;
					try {
						var o = e();
						return (
							o.setDataMover({
	...
	ft = Qt;
	var Jt,
		Zt = (null == (Jt = $t()).ENV && (Jt.ENV = new jt(Gt())),
		(ht = function() {
	...
	function re(t, e, n, r) {
		...
		if (
			...
			ne(r, o, e, n),
			null == t ||
				(!z(t) && !Array.isArray(t) && 'number' != typeof t && 'boolean' != typeof t && 'string' != typeof t))
		) {
			var i = null == t ? 'null' : t.constructor.name;
			throw new Error(
				"Argument '" + e + "' passed to '" + n + "' must be a Tensor or TensorLike, but got '" + i + "'"
			);
		}
		var a = ee(t);
	...
	function Ae(t, e, n, i, r, o, a, s, u) {
		...
		for (var c = [], l = [], h = [], p = 0; p < t.length; p++)
			(c[p] = De(r, e, i, t, p)), (l[p] = Me(o, n, i, t, p)), u & (1 << p) && ((l[p] = c[p] + 1), h.push(p));
	...
	var Pn = function(t, e, n, r) {
		...
		cr = function(t, e, n, r, o) {
			...
			var p = 'bilinear' === r ? 1 : 0,
				...
				m =
					1 < l
						? [ '' + (a - 1) / (l - 1), '(y2-y1) * height_ratio', 'y1*' + d + ' + float(y)*(height_scale)' ]
						: [ '0.0', '0.0', '0.5 * (y1+y2) * ' + d ],
				g = m[0],
				y = m[1],
				x = m[2],
				w =
					1 < h
						? [ '' + (s - 1) / (h - 1), '(x2-x1) * width_ratio', 'x1*' + v + ' + float(x)*(width_scale)' ]
						: [ '0.0', '0.0', '0.5 * (x1+x2) * ' + v ],
				b = w[0],
				E = w[1],
				C = w[2];
	...
	function Tr(t, e, n, r, o) {
		...
		for (
			...
			for (
				var d = f * n * r, v = f * p, m = a ? 4 : 0, g = r + (a ? 1 : 0), y = v, x = d, w = d + r, b = 0;
				b < c;
				++b
			) {
		...
		Mo = (function() {
			...
			return (
				...
				(t.prototype.deleteMatrixTexture = function(t) {
					...
					this.throwIfDisposed(),
						this.outputTexture === t &&
							(Zr(this.gl, this.debug, this.framebuffer), (this.outputTexture = null)),
				...
				(t.prototype.createProgram = function(t) {
					...
					return (
						...
						this.vertexAttrsAreBound ||
							(this.setProgram(o),
							(this.vertexAttrsAreBound = bo(e, this.debug, this.program, this.vertexBuffer))),
						o
					);
				}),
				...
				(t.prototype.unbindTextureToFrameBuffer = function() {
					null != this.outputTexture
						? (Jr(this.gl, this.debug, this.outputTexture, this.framebuffer), this.debug && to(this.gl))
	...
	function Oo(t, s) {
		if (t.length !== s.length)
			throw Error(
				'Binary was compiled with ' + t.length + ' inputs, but was executed with ' + s.length + ' inputs'
			);
		t.forEach(function(t, e) {
	...
	var Vo = function(n, t, e) {
		...
		jo = function(t, e) {
			...
			'prod' === e
				? (a = '1.0')
				: 'min' === e ? ((a = '1.0 / 1e-20'), (s = 'min')) : 'max' === e && ((a = '-1.0 / 1e-20'), (s = 'max'));
			var u = e + '(' + e + '(' + e + '(minMaxValue[0], minMaxValue[1]), minMaxValue[2]), minMaxValue[3])';
			'sum' === e
				? (u = 'sumValue')
				: 'prod' === e ? (u = 'prodValue') : 'all' === e ? (u = 'allValue') : 'any' === e && (u = 'anyValue');
		...
		$o = function(t, e) {
			...
			this.userCode =
				...
				(function(t, e) {
					if (t.length !== e.length)
						throw new Error(
							'Vectors to be dotted must be of the same length -got ' + t.length + ' and ' + e.length
						);
		...
		ti = function(i, a) {
			...
			function l(o) {
				var t = i.map(function(t, e) {
					return (
						(n = e), (r = o), -1 !== a.indexOf(n) && 1 !== i[n] ? i[n] + ' - ' + r[n] + ' - 1' : '' + r[n]
					);
					var n, r;
				});
		...
		oi = (function() {
			...
			return (
				(t.prototype.getCustomSetupFunc = function(n) {
					...
					return function(t, e) {
						(null == r.startLoc &&
							((r.startLoc = t.getUniformLocationNoThrow(e, 'start')), null == r.startLoc)) ||
	...
	function ci(t, e) {
		...
		if (t === wr.RENDER || null == t)
			return e
				? Zt.get('WEBGL_RENDER_FLOAT32_ENABLED') ? br.PACKED_2X2_FLOAT32 : br.PACKED_2X2_FLOAT16
				: Zt.get('WEBGL_RENDER_FLOAT32_ENABLED') ? br.UNPACKED_FLOAT32 : br.UNPACKED_FLOAT16;
	...
	var hi = function(t, e) {
		...
		var o = Dn(this.rank),
			i = (function(t) {
				...
				for (
					var n = [ 'resRC.x', 'resRC.y', 'resRC.z', 'resRC.w', 'resRC.u' ], r = [], o = 0;
					o < t.length;
					o++
				)
					r.push('imod(' + n[o] + ', ' + t[o] + ')');
				...
				(t.prototype.nextValue = function() {
					...
					for (var e, n, r = !1; !r; ) {
						for (
							...
							1 <= (a = (o = 2 * this.random() - 1) * o + (i = 2 * this.random() - 1) * i) || 0 === a;
	...
	var Gi = Fe({
		...
		ra = Fe({
			randomNormal_: function(t, e, n, r, o) {
				...
				for (var i = new Wi(e, n, r, !1, o), a = zi(t, r), s = 0; s < a.values.length; s++)
		...
		la = Fe({
			truncatedNormal_: function(t, e, n, r, o) {
				if ((void 0 === e && (e = 0), void 0 === n && (n = 1), null != r && 'bool' === r))
					throw new Error('Unsupported data type ' + r);
				for (var i = new Wi(e, n, r, !0, o), a = zi(t, r), s = 0; s < a.values.length; s++)
					a.values[s] = i.nextValue();
				return a.toTensor();
			}
		}),
				...
				return R(this, function(t) {
					switch (t.label) {
						...
						case 2:
							...
							for (s = new lt([ a ], e.dtype), u = new lt([ a ], 'int32'), l = c = 0; c < r.length; c++)
	...
	var va = (function() {
		function t(t) {
			...
			if (null == t) {
				...
				(this.binaryCache = ((n = Zt.get('WEBGL_VERSION')) in da || (da[n] = {}), da[n])),
					(this.gpgpu = new Mo(e)),
		...
		return (
						...
						switch (t.label) {
							case 0:
								...
								if (
									...
									return (
										(p = new mi(c, wi)),
										(f = this.compileAndRun(p, [ { dataId: S, shape: c, dtype: h } ])),
								...
								if (
									...
									!Zt.get('WEBGL_DOWNLOAD_FLOAT_ENABLED') && 2 === Zt.get('WEBGL_VERSION'))
								)
									throw new Error(
											...
											: ((x = B(c)),
												u
													? ((w = oo(c)),
														...
														this.gpgpu
															.downloadPackedMatrixFromBuffer(g, w, b, E, s[0], s[1])
															.subarray(0, x))
													: this.gpgpu
			...
			(t.prototype.getValuesFromTexture = function(e) {
				...
				var f = ue(function() {
					...
					v = this.gpgpu
						.downloadByteEncodedFloatMatrixFromOutputTexture(d.texture, d.texShape[0], d.texShape[1])
						.subarray(0, u);
			...
			(t.prototype.getCPUBackend = function() {
				return Zt.get('WEBGL_CPU_FORWARD')
					? (null == this.cpuBackend && (this.cpuBackend = Zt.findBackend('cpu')), this.cpuBackend)
					: null;
			}),
			...
			(t.prototype.shallowSlice = function(t, e, n) {
				...
				r.slice && (a += r.slice.flatOffset),
					(i.slice = { flatOffset: a, origDataId: (r.slice && r.slice.origDataId) || t.dataId });
			...
			(t.prototype.argReduce = function(t, e, n) {
				...
				var i = ke(o),
					...
					h = [ t ];
				return (
					null != n && h.push(n), this.compileAndRun(a, h, l), 1 === l.shape[1] ? l : this.argReduce(t, e, l)
				);
			}),
			...
			(t.prototype.segOpCompute = function(t, e, n, r, o) {
				var i = t.shape[0],
					...
					s = (function(t, e) {
						var n,
							r = !1;
						for (t <= 30 ? ((n = t), (r = !0)) : (n = $(t, Math.floor(Math.sqrt(t)))); !r; )
							e < n || n === t ? (r = !0) : (n = $(t, n + 1));
						return n;
					})(a, o),
			...
			(t.prototype.cumsum = function(t, e, n, r) {
				if (e !== t.rank - 1)
					throw new Error(
						'WebGL cumsum shader expects an inner-most axis=' + (t.rank - 1) + ' but got axis=' + e
					);
			...
			(t.prototype.exp = function(t) {
				var e;
				return (
					(e = Zt.get('WEBGL_PACK') ? new Ei(t.shape, xi) : new mi(t.shape, xi)), this.compileAndRun(e, [ t ])
				);
			}),
			(t.prototype.expm1 = function(t) {
			...
			(t.prototype.relu = function(t) {
				var e;
				return (
					(e = Zt.get('WEBGL_PACK') ? new Ei(t.shape, bi) : new mi(t.shape, yi)), this.compileAndRun(e, [ t ])
				);
			}),
			(t.prototype.prelu = function(t, e) {
				var n = Zt.get('WEBGL_PACK_BINARY_OPERATIONS')
			...
			(t.prototype.unstack = function(t, e) {
				for (var n = t.shape[e], r = new Array(t.rank - 1), o = 0, i = 0; i < t.rank; i++)
					i !== e && (r[o++] = t.shape[i]);
			...
			(t.prototype.reshape = function(t, e) {
				var n = this.texData.get(t.dataId);
				return !n.isPacked || uo(t.shape, e) || (null !== n.texture && uo(n.shape, e))
					? sn(t, e)
			...
			(t.prototype.nonMaxSuppression = function(t, e, n, r, o) {
				return (
					fe('tf.nonMaxSuppression() in webgl locks the UI thread. Call tf.nonMaxSuppressionAsync() instead'),
			...
			(t.prototype.compileAndRun = function(o, t, e, n, r) {
				...
				var a = t.map(function(t) {
					...
					if (null == e.texture) {
						...
						(t = e.isPacked ? i.unpackTensor(t) : i.packTensor(t)), (e = i.texData.get(t.dataId));
				...
				return (
					h &&
						((s = this.endTimer(s)),
						this.activeTimers.push({ name: o.constructor.name, query: this.getQueryTime(s) })),
					Zt.get('WEBGL_LAZILY_UNPACK') || !this.texData.get(e.dataId).isPacked || o.isPackShader
						? e
						: this.unpackTensor(e)
				);
			}),
				...
				return (
					...
					null != e &&
						(n.values = (function(t, e) {
							...
							for (
								var n = 'int32' === e ? new Int32Array(t.length) : new Uint8Array(t.length), r = 0;
								r < n.length;
								++r
							)
								n[r] = Math.round(t[r]);
			...
			(v =
				0 === s.rank || 1 === s.rank
					...
					: 2 === s.rank
						...
						: 3 === s.rank ? s.as4D(1, s.shape[0], s.shape[1], s.shape[2]) : s),
			Zt.engine
				.runKernel(
					function(t, e) {
					...
					function(n, t) {
						...
						return {
							$x: function() {
								return 1 === r.rank
									? n.mul(ca(p.as4D(1, 1, 1, r.shape[0]), u)).mul(a).reshape(e.shape)
			...
			: 0 === t.rank
				...
				: 1 === t.rank
					...
					: 2 === t.rank
						...
						: 3 === t.rank ? t.as4D(1, t.shape[0], t.shape[1], t.shape[2]) : t;
	}
	function rs() {
		Qt(
			'tf.batchNormalization() is going away. Use tf.batchNorm() instead, and note the positional argument change of scale, offset, and varianceEpsilon'
						...
						x: function() {
							return (function(t, e, n, r, o, i, a, s) {
								...
								D(c.rank === u.rank, function() {
									...
									D(4 === u.rank, function() {
										return (
											'Error in maxPoolBackprop: dy must be rank 4 but got rank ' + u.rank + '.'
										);
									}),
									D(4 === c.rank, function() {
										return (
						...
						x: function() {
							return (function(t, e, n, r, o, i) {
								...
								3 === s.rank &&
									...
									D(4 === c.rank, function() {
										return (
											'Error in avgPoolBackprop: dy must be rank 4 but got rank ' + c.rank + '.'
										);
									}),
									D(4 === u.rank, function() {
										return (
			...
			slice_: function(t, e, n) {
				...
				(r =
					'number' == typeof e
						...
						: e.length < i.rank ? e.concat(new Array(i.rank - e.length).fill(0)) : e.slice()),
					(o = (o =
						null == n
							? new Array(i.rank).fill(-1)
							: 'number' == typeof n
								? [ n ].concat(new Array(i.rank - 1).fill(-1))
								: n.length < i.rank ? n.concat(new Array(i.rank - n.length).fill(-1)) : n).map(function(
						t,
						e
					) {
						return 0 <= t
		...
		ou = Fe({
			moments_: function(t, e, n) {
				...
				var r = k(e, (t = re(t, 'x', 'moments')).shape),
					...
					i = o.shape;
				return (
					n || (i = be(o.shape, r)), { mean: o, variance: t.toFloat().sub(o.reshape(i)).square().mean(r, n) }
				);
			}
		}),
		iu = Fe({
		...
		Cu = Fe({
			div_: function(t, e) {
				var n,
					r = re(t, 'a', 'div'),
					o = re(e, 'b', 'div');
				if (((n = Tt(r, o)), (r = n[0]), (o = n[1]), 'int32' === r.dtype && 'int32' === o.dtype))
					return Su(r, o);
				var a = xn(r.shape, o.shape);
				return Zt.engine.runKernel(
					function(t, e) {
			...
			return (
				(function(t, e, n, r) {
					...
					if (0 !== e.rank && (1 !== e.rank || a !== o))
						throw new Error(
							'sparseValues has incorrect shape ' + e.shape + ', should be [] or [' + o + ']'
						);
						...
						e = function(l) {
							...
							(m = (t = Zt.engine.tidy(function() {
								...
								m =
									1 === i.shape[0]
										? v.clone()
										: v.concat(i.slice([ 1, 0 ], [ i.shape[0] - 1, i.shape[1] ]), 0);
		...
		Ac = Fe({
			qr_: function(t, o) {
				...
				var e = t.shape.slice(0, t.shape.length - 2).reduce(function(t, e) {
					...
					a = [];
				return (
					ha(t.reshape([ e, t.shape[t.shape.length - 2], t.shape[t.shape.length - 1] ]), 0).forEach(function(
						t
					) {
						var e = Ic(t, o),
							n = e[0],
						...
						.runKernel(
							...
							function(t, e) {
								...
								if (null == l || 'linear' === l) n = t;
									...
									if ('relu' !== l)
										throw new Error(
											'Gradient for activation ' + l + ' has not been implemented yet.'
										);
									n = t.mul(i.step());
								}
								var a = {};
		...
		return (
				...
				for (
					...
					for (var C = 0; C < i; C += b)
						for (var _ = 0; _ < a; _ += b)
							for (var S = 0; S < o; S += b)
								for (
									var R = Math.min(C + b, i), N = Math.min(_ + b, a), k = Math.min(S + b, o), I = C;
									I < R;
									I++
								)
									for (var T = _; T < N; T++) {
			...
			(t.prototype.cumsum = function(t, e, n, r) {
				if ((this.assertNotComplex(t, 'cumsum'), e !== t.rank - 1))
					throw new Error(
						'backend.cumsum in CPU expects an inner-most axis=' + (t.rank - 1) + ' but got axis=' + e
					);
				for (
			...
			(t.prototype.round = function(t) {
				...
				for (var e = t.dataSync(), n = new Float32Array(e.length), r = 0; r < e.length; ++r) {
					...
					e[r] - o < 0.5
						? (n[r] = Math.floor(e[r]))
						: 0.5 < e[r] - o ? (n[r] = Math.ceil(e[r])) : (n[r] = o % 2 == 0 ? o : o + 1);
				}
				return dt.make(t.shape, { values: n });
			}),
			(t.prototype.exp = function(t) {
			...
			(t.prototype.relu = function(t) {
				...
				for (var e = Qe(t.shape, t.dtype), n = e.dataSync(), r = t.dataSync(), o = 0; o < r.length; ++o)
					n[o] = Math.max(0, r[o]);
				return e;
			}),
			(t.prototype.prelu = function(t, e) {
			...
			(t.prototype.softplus = function(t) {
				...
				for (
					var e = Math.log(1.1920928955078125e-7) + 2, n = new Float32Array(t.size), r = t.dataSync(), o = 0;
					o < r.length;
					++o
				) {
					var i,
			...
			(t.prototype.erf = function(t) {
				...
				for (var e = new Float32Array(t.size), n = t.dataSync(), r = 0; r < n.length; ++r) {
					...
					e[r] =
						1 -
						((((1.061405429 * i - 1.453152027) * i + 1.421413741) * i - 0.284496736) * i + 0.254829592) *
							i *
							Math.exp(-o * o);
				}
				return dt.make(t.shape, { values: e });
							...
							if (!(w < 0 || w >= n.inHeight))
								for (var b = x * e.strides[0], E = d + w * t.strides[1], C = 0; C < n.outWidth; ++C)
									for (var _ = g + C * n.outChannels, S = C * n.strideWidth - u, R = 0; R < o; R++) {
										...
										if (!(N < 0 || N >= n.inWidth))
											for (
												var k = b + R * e.strides[1], I = E + N * n.inChannels, T = k, A = 0;
												A < n.inChannels;
												++A
											) {
							...
							if (!(C < 0 || C >= n.inDepth))
								for (var _ = E * e.strides[0], S = g + C * t.strides[1], R = 0; R < n.outHeight; ++R)
									for (var N = w + R * p.strides[2], k = R * n.strideHeight - h, I = 0; I < o; I++) {
										...
										if (!(T < 0 || T >= n.inHeight))
											for (
												var A = _ + I * e.strides[1], D = S + T * t.strides[2], M = 0;
												M < n.outWidth;
												++M
											)
												for (
													var O = N + M * n.outChannels, P = M * n.strideWidth - l, F = 0;
													F < i;
													F++
												) {
													var L = P + F * u;
													if (!(L < 0 || L >= n.inWidth))
														for (
															...
															for (var G = f[W + U], V = 0; V < n.outChannels; ++V)
																v[O + V] += G * d[z + V];
															z += n.outChannels;
														}
												}
			...
			(t.prototype.conv2dDerInput = function(t, e, n) {
				...
				for (
					...
					for (var M = 0; M < E; ++M)
						for (var O = 0; O < C; ++O)
							for (
								var P = O - T, F = Math.max(0, Math.ceil(P / k)), L = Math.min(R, (w + P) / k), B = 0;
								B < _;
								++B
							) {
								for (
			...
			(t.prototype.conv3dDerInput = function(t, e, n) {
				for (
					...
					for (var U = 0; U < R; ++U)
						for (var G = 0; G < N; ++G)
							for (
								var V = G - L, H = Math.max(0, Math.ceil(V / O)), q = Math.min(A, (C + V) / O), j = 0;
								j < k;
								++j
							)
								for (
									...
									for (var j = 0, $ = 0; $ < n.batchSize; ++$)
										for (var K = $ * _, X = $ * y, Y = D; Y < M; ++Y)
											for (var Q = (A + Y * r - k) * S + K, J = Y * x + X, Z = F; Z < L; ++Z)
												for (
													var tt = (P + Z * o - T) * R + Q, et = Z * w + J, nt = z;
													nt < U;
													++nt
												) {
													var rt = nt * b + et;
			...
			(t.prototype.depthwiseConv2DDerInput = function(t, e, n) {
				...
				for (
					...
					for (var O = 0; O < E; ++O)
						for (var P = 0; P < C; ++P)
							for (
								var F = P - T, L = Math.max(0, Math.ceil(F / k)), B = Math.min(R, (w + F) / k), W = 0;
								W < _;
								++W
							) {
								for (
					...
					for (var f = 0; f < e.inChannels; ++f)
						for (var d = 0; d < e.outHeight; ++d) {
							...
							for (var g = Math.min(e.inHeight, s + v), y = 0; y < e.outWidth; ++y) {
								...
								for (
									var b = Math.min(e.inWidth, u + x), E = Number.NEGATIVE_INFINITY, C = -1, _ = m;
									_ < g;
									_ += i
								)
			...
			(t.prototype.resizeNearestNeighbor = function(t, e, n, r) {
				...
				for (
					...
					for (var g = m * t.strides[0], y = 0; y < e; y++)
						for (
							var x = f * y,
								w = g + Math.min(a - 1, r ? Math.round(x) : Math.floor(x)) * t.strides[1],
								b = 0;
							b < n;
							b++
						)
							for (
								var E = d * b,
									C = w + Math.min(s - 1, r ? Math.round(E) : Math.floor(E)) * t.strides[2],
									_ = 0;
								_ < u;
								_++
							) {
			...
			(t.prototype.resizeNearestNeighborBackprop = function(t, e, n) {
				...
				for (
					...
					for (var E = b * e.strides[0], C = 0; C < i; C++)
						for (
							var _ = E + C * e.strides[1], S = Math.floor(C * g), R = Math.floor(S - x / 2), N = 0;
							N < a;
							N++
						)
							for (
								var k = _ + N * e.strides[2], I = Math.floor(N * y), T = Math.floor(I - w / 2), A = 0;
								A < s;
								A++
							) {
											...
											for (var L = 0; L < w; L++) {
												...
												if (!(B < 0 || l <= B)) {
													var W = P + B * t.strides[2],
														z = B * m;
													N === Math.min(a - 1, n ? Math.round(z) : Math.floor(z)) &&
														(D += p[W + A]);
												}
											}
									}
			...
			(t.prototype.localResponseNormalization4D = function(t, a, e, n, r) {
				...
				function l(t) {
					for (
						var e = t % s, n = t - e + Math.max(0, e - a), r = t - e + Math.min(e + a, u), o = 0;
						n <= r;
						n++
					) {
						var i = c[n];
			...
			(t.prototype.LRNGrad = function(t, e, n, r, o, i, a) {
				...
				for (
					...
					for (
						var d = f % s, v = f - d + Math.max(0, d - r), m = f - d + Math.min(s, d + r + 1), g = 0, y = v;
						y < m;
						y++
					)
						g += Math.pow(c[y], 2);
			...
			(t.prototype.fftImpl = function(t, e) {
				...
				var i = t.dataSync(),
					a = (function(t) {
						for (
							var e = new Float32Array(t.length / 2), n = new Float32Array(t.length / 2), r = 0;
							r < t.length;
							r += 2
						)
			...
			(t.prototype.fftRadix2 = function(t, e, n) {
				...
				var r = t.dataSync(),
					...
					i = (function(t) {
						for (
							var e = Math.ceil(t.length / 4), n = new Float32Array(e), r = new Float32Array(e), o = 0;
							o < t.length;
							o += 4
						)
							...
							if (T < 0 || u - 1 < T)
								...
								for (A = 0; A < f; A++)
									if ((q = 1 < f ? C * (c - 1) + A * k : 0.5 * (C + S) * (c - 1)) < 0 || c - 1 < q)
										for (D = 0; D < l; D++)
											(M = D + A * x[2] + I * x[1] + w * x[0]), (d.values[M] = i);
									else {
										var L = Math.floor(q),
											B = Math.ceil(q),
											W = q - L;
	...
	function el(t) {
		if (-1 === t.indexOf(Zc))
			throw new Error(
				'The url string provided does not contain a scheme. Supported schemes are: ' + tl.getSchemes().join(',')
			);
						...
						case 0:
							return (
								...
								D(0 < (r = Jc.getSaveHandlers(h)).length, function() {
									return (
										'Copying failed because no save handler is found for destination URL ' + h + '.'
									);
								}),
	...
	var ul = (function() {
								...
								if (null == h) {
									...
									(n.onsuccess = function() {
										var n = (o = r.transaction(ol, 'readwrite'))
											.objectStore(ol)
											.put({ modelPath: p.modelPath, modelArtifacts: h, modelArtifactsInfo: i });
										(n.onsuccess = function() {
		...
		cl = function(t) {
			return Zt.get('IS_BROWSER') && !Array.isArray(t) && t.startsWith(ul.URL_SCHEME)
											...
											(i.onsuccess = function() {
												if (null == i.result)
													return (
														...
														s(
															new Error(
																"Cannot find model with path '" + u + "' in IndexedDB."
															)
														)
													);
												var t = o.delete(u),
	...
	var wl = (function() {
		...
		bl = function(t) {
			return Zt.get('IS_BROWSER') && !Array.isArray(t) && t.startsWith(wl.URL_SCHEME)
		...
		return (
			...
			(t.prototype.removeModel = function(o) {
				return m(this, void 0, void 0, function() {
					...
					return R(this, function(t) {
						if (
							((o = (e = o).startsWith(wl.URL_SCHEME) ? e.slice(wl.URL_SCHEME.length) : e),
							(n = yl(o)),
	...
	Jc.registerSaveRouter(function(t) {
		return Zt.get('IS_BROWSER') && !Array.isArray(t) && t.startsWith(Cl.URL_SCHEME)
			? (void 0 === (e = t.slice(Cl.URL_SCHEME.length)) && (e = 'model'), new Cl(e))
			: null;
		var e;
	});
	var kl = (function() {
	...
	function Hl(t, e, n) {
		if (t instanceof dt || e instanceof dt) {
			if (t instanceof dt && e instanceof dt) {
				if (t.dtype !== e.dtype)
					throw new Error(
						'Arrays are of different type actual: ' + t.dtype + ' vs expected: ' + e.dtype + '.'
					);
				if (!E(t.shape, e.shape))
					throw new Error(
						'Arrays are of different shape actual: ' + t.shape + ' vs expected: ' + e.shape + '.'
					);
			}
		} else {
						...
						ue(function() {
							...
							if (h.centered) {
								var e = h.decayScalar.mul(u).add(h.oneMinusDecay.mul(l)),
									n = h.momentumScalar
										.mul(c)
										.add(h.c.mul(l).div(t.sub(e.square().add(h.epsilonScalar)).sqrt()));
	...
	var _h,
		Sh = (function() {
			function l(t, e) {
				...
				if (!o && !r)
					throw new Error(
						'Box.constructor - expected box to be IBoundingBox | IRect, instead have ' + JSON.stringify(n)
					);
				var i = o ? [ n.x, n.y, n.width, n.height ] : [ n.left, n.top, n.right - n.left, n.bottom - n.top ],
					...
					u = i[2],
					c = i[3];
				l.assertIsValidBox({ x: a, y: s, width: u, height: c }, 'Box.constructor', e),
					(this._x = a),
					(this._y = s),
					(this._width = u),
					(this._height = c);
			...
			return (
				...
				(l.assertIsValidBox = function(t, e, n) {
					...
					if (!n && (t.width < 0 || t.height < 0))
						throw new Error(
							e + ' - width (' + t.width + ') and height (' + t.height + ') must be positive numbers'
						);
				}),
	...
	var Vh = function(t) {
		...
		Hh = (function() {
			function r(t, e, n) {
				void 0 === n && (n = {}),
					(this.text = 'string' == typeof t ? [ t ] : t instanceof r ? t.text : t),
					(this.anchor = e),
	...
	function sp(t) {
		...
		return t instanceof n
			...
			: t instanceof r ? new ch(t.videoWidth, t.videoHeight) : new ch(t.width, t.height);
	}
	function up(t) {
		var e = t.width,
			n = t.height,
				...
				switch (t.label) {
					...
					case 1:
						if (!((e = t.sent()).status < 400))
							throw new Error(
								'failed to fetch: (' + e.status + ') ' + e.statusText + ', from url: ' + e.url
							);
						return [ 2, e ];
				}
			});
			...
			(t.prototype.traversePropertyPath = function(n) {
				...
				var t = n.split('/').reduce(function(t, e) {
						if (!t.nextObj.hasOwnProperty(e))
							throw new Error(
								'traversePropertyPath - object does not have property ' + e + ', for path ' + n
							);
	...
	function Np(t) {
		...
		if (
			...
			throw new Error(
				'config.classes has to be an array class names: string[], have: ' + JSON.stringify(t.classes)
			);
		if (
			...
			throw new Error(
				'config.anchors has to be an array of { x: number, y: number }, have: ' + JSON.stringify(t.anchors)
			);
	...
	function Dp(t, e) {
		...
		return {
			...
			extractConvWithBatchNormParams: function(t) {
				...
				return {
					conv: r(t + '/conv'),
					bn: { sub: n((e = t + '/bn') + '/sub', 1), truediv: n(e + '/truediv', 1) }
				};
			},
			...
			return (
				...
				(r.prototype.runTinyYolov2 = function(t, e) {
					...
					return (
						...
						Kh(
							(n = Ip((n = Ip((n = Us(n, [ 2, 2 ], [ 1, 1 ], 'same')), e.conv6)), e.conv7)),
							e.conv8,
							'valid',
							!1
						)
				...
				(r.prototype.forwardInput = function(e, n) {
					...
					return ue(function() {
						...
						return (
							(t = (t = r.config.meanRgb ? Ep(t, r.config.meanRgb) : t).div(Ve(256))),
									...
									return (
										...
										(u = ue(function() {
											...
											return [
												...
												T.withClassScores
													? Le(
															t.slice([ 0, 0, 0, 5 ], [ a, a, s, T.config.classes.length ]),
															3
														)
													: Ve(0)
											];
	...
	function Gp(o, i, a, s) {
		return (
			...
			ue(function() {
				var t = Xu(
						a
							? xu(Ss(o, i.conv0.filters, s ? [ 2, 2 ] : [ 1, 1 ], 'same'), i.conv0.bias)
	...
	function qp(t, e) {
		...
		return {
			extractDenseBlock3Params: function(t, e) {
				return (
					void 0 === e && (e = !1),
					{ conv0: e ? r(t + '/conv0') : o(t + '/conv0'), conv1: o(t + '/conv1'), conv2: o(t + '/conv2') }
				);
			},
	...
	var Xp = (function(r) {
		...
		Qp = (function() {
			function t(n) {
				...
				if (7 !== n.length)
					throw new Error(
						'FaceExpressions.constructor - expected probabilities.length to be 7, have: ' + n.length
					);
																...
																case 1:
																	return (
																		...
																		[
																			2,
																			new nf(
																				Array(68).fill(0).map(function(t, e) {
	...
	var Cf = (function(t) {
			...
			return (
				...
				(e.prototype.forwardInput = function(e) {
					...
					return ue(function() {
						var t = Up(
							Ep(e.toBatchTensor(112, !0), [ 122.782, 117.001, 104.298 ]).div(Ve(255)),
							n.dense0,
							!0
						);
	...
	function If(u, c) {
		...
		return {
			...
			extractResidualLayerParams: function(t, e, n, r, o) {
				return (
					void 0 === o && (o = !1),
					{ conv1: i((o ? 0.5 : 1) * t, e, n, r + '/conv1'), conv2: i(t, e, n, r + '/conv2') }
				);
			}
		};
	}
	...
	var Mf = (function(t) {
		...
		return (
			...
			(e.prototype.forwardInput = function(n) {
				...
				return ue(function() {
					var t = kf(
							Ep(n.toBatchTensor(150, !0).toFloat(), [ 122.782, 117.001, 104.298 ]).div(Ve(256)),
							r.conv32_down
						),
						e = (t = Df(
							(t = Af(
	...
	function Ff(l, h) {
		function i(t, e, n, r, o) {
			var i = $e(l(t * e * n * n), [ n, n, t, e ]),
				a = He(l(e));
			return (
				h.push({ paramPath: r + '/filters' }, { paramPath: r + '/' + (o ? 'batch_norm_offset' : 'bias') }),
				{ filters: i, bias: a }
			);
		}
		function p(t, e, n, r) {
		...
		return (
			...
			ue(function() {
				...
				return (
					...
					(t = id(
						(t = Kh((t = Us(t, r ? [ 2, 2 ] : [ 3, 3 ], [ 2, 2 ], 'same')), n.conv2, 'valid')),
						n.prelu2_alpha
					)),
					(t = id(
						(t = Kh((t = r ? t : Us(t, [ 3, 3 ], [ 2, 2 ], 'valid')), n.conv3, 'valid')),
						n.prelu3_alpha
					))
				);
			})
		...
		var e = t
				.map(function(l) {
					return ue(function() {
						...
						return (
							(t.pnet = Date.now() - n),
							{ scoresTensor: ha(ha(u, 3)[1])[0], regionsTensor: ha(c)[0], scale: l, statsForScale: t }
						);
					});
				})
				.map(function(t) {
							...
							(r = n.map(function(t) {
								var a,
									...
									ue(function() {
										var t = ad(a, s),
											e = id(
												$p(ia(t, [ t.shape[0], s.fc1.weights.shape[0] ]), s.fc1),
												s.prelu4_alpha
											),
											n = $p(e, s.fc2_1),
											r = $i(eu(n, 1), 1),
							...
							(i = n.map(function(t) {
								var s,
									...
									ue(function() {
										var t = ad(s, u);
										t = id(
											(t = Kh((t = Us(t, [ 2, 2 ], [ 2, 2 ], 'same')), u.conv4, 'valid')),
											u.prelu4_alpha
										);
										var e = id(
												$p(ia(t, [ t.shape[0], u.fc1.weights.shape[0] ]), u.fc1),
												u.prelu5_alpha
											),
											n = $p(e, u.fc2_1),
											r = $i(eu(n, 1), 1),
											...
											(b = w.boxes.map(function(e, t) {
												return of(
													Wp(
														...
														new Lp(
															w.scores[t],
															new Th(e.left / c, e.top / u, e.width / c, e.height / u),
															{ height: u, width: c }
														)
													),
													new mf(
		...
		yd = (function(n) {
			function t(t) {
				...
				var e = Object.assign(
					...
					t ? { anchors: md, meanRgb: gd } : { anchors: vd, withClassScores: !0 }
				);
						...
						return P(this, function(t) {
							switch (t.label) {
								case 0:
									return (
										(n = (e = this).input),
										(r = e.options) instanceof Pf ? [ 4, xd.mtcnn.forward(n, r) ] : [ 3, 2 ]
									);
								case 1:
									return [
										2,
			...
			return P(this, function(t) {
				switch (t.label) {
					case 0:
						return [
							4,
							$d(e, new Hf(n ? { minConfidence: n } : {})).withFaceLandmarks().withFaceDescriptors()
						];
					case 1:
						return [ 2, t.sent() ];
				}
